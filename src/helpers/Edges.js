    ...
    const markers = fetchLayerPoints(polygon).map(point => {
        ...
        marker.on('dragstart', function mouseDown() {
            ...
            function mouseUp() {
                ...
                marker.off('dragend', mouseUp);
                marker.off('dragstart', mouseDown);
                marker.off('drag', mouseMove);
