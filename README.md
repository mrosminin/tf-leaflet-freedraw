...
> __As of version 2.14.0 only leaflet >= 1.7.0 is supported.
Please note, only android tablets and the chrome browser have been tested for touch support so no promises are made for any other type of device/browser.__
